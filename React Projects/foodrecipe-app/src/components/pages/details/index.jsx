...
export default function Details() {
    ...
    return <div className="container mx-auto py-10 grid grid-cols-1 lg:grid-cols-2 gap-10">
        ...
        <div className="flex flex-col gap-3">
            <span className="text-sm text-cyan-700 font-meduim">
            ...
            <div>
                <button onClick ={() => handleAddToFavorite(recipeDetailsData?.recipe)} className="p-3 px-8 rounded-lg text-sm uppercase font-meduim tracking-wider mt-3 inline-block shadow-md bg-black text-white">
                {
